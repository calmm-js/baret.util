...
export const parallel = /*#__PURE__*/ B.mergeAll
export const delay = /*#__PURE__*/I_curry((ms, xs) => toConstant(xs).delay(ms))
export const endWith = /*#__PURE__*/I_curry((v, xs) => toConstant(xs).toEventStream().concat(toConstant(v)).toProperty())
...
export const interval = /*#__PURE__*/I_curry(B.interval)
export const later = /*#__PURE__*/I_curry(B.later)
export const lazy = th => seq(toProperty(), flatMapLatest(th), toProperty)
export const never = /*#__PURE__*/B.never()
...
export const startWith = /*#__PURE__*/I_curry((x, xs) => toConstant(xs).startWith(x))
...
export const set = /*#__PURE__*/I_curry((settable, xs) => {
  ...
  if (ss instanceof Observable)
    return ss.startWith(toUndefined)
})
...
export function setProps(observables) {
  ...
  return e => {
    if (unsub)
      unsub()
    const observable = template(observables)
    unsub = observable.onValue(values => {
